...
def main():
    ...
    if args.stream:
        ...
        #download_hls_stream('http://dfwlive-sponsored.akamaized.net/Content/HLS_hls.00/Live/channel(AUDHD-3304.dfw.720.tv)/index.m3u8',id='aka',refreash_interval=24, num_refreshes=30)
         download_hls_stream('http://cdn.prepro.cvattv.com.ar/vod/vod/ANTE1265303000000014-La_Embajada_T1_E04/_/vod_verimatrix_rotating/ANTE1265303000000014-La_Embajada_T1_E04.m3u8', id='vod', num_workers=30)
         #download_hls_stream('http://cdn.cvattv.com.ar/live/c3eds/ArtearHD/verimatrix_rotating/ArtearHD-video=1344000.m3u8', id='demo', refreash_interval=4, num_workers=10)
        # download_hls_stream('http://cwm-sp-lab3.hq.k.grp/live/hls/clear/bbc1clear/index.m3u8', 'bbc1')
        #download_hls_stream('http://nscreenn-chtmod.cdn.hinet.net/live/Home/index.m3u8', id='nscreen', num_workers=10, refreash_interval=5, num_refreshes=20)
        #download_hls_stream('https://rr.ew.waoo.tv/__cl/cg:default/__c/49-83_HTTP/__op/clear/__f/index.m3u8', id='waoo',refreash_interval=8, num_refreshes=30)
